...
class GraphicalInterface:
    def __init__(self):
        ...
        x_player, y_player, width_player, height_player = 50, self.win_height-50, 40, 60
        x_army, y_army, x_count_army, y_count_army = 20, 20, 5, 4
        ...
        self.army = Army(x_army, y_army, x_count_army, y_count_army, x_army_jump, y_army_jump,
                         width_enemy, height_army, (0, 255, 0))
        self.bullets = []
